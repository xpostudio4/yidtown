...
<div class="container">
 <article class="page-content">
   <ul class="page-nav">
    ...
    <li> > <a href="<?php echo JEWISH_URL;?>/myaccount/classified_message/<?php echo $this->uri->segment(3)?>/">
...
<?php $user_log=$this->session->userdata('logged_in'); //print_r($user_log['user_id']);
 ...
 foreach($list as $v){?>
   ...
   <!--    /*=======================*/-->
   <?php /*$re=$this->businessmod->get_all_innitial_comment($user_log['user_id'],'CL',$v['id']);  date('jS F Y', $yrdata)
	   foreach($re as $rept){*/?>
