...
<?php $attributes = array('id' => 'login');
            ...
            <section class="loginBox">
                ...
                <p>
                    ...
                    <input type="email" id="inputEmailHandle" name="inputEmailHandle" value="" autocomplete="off" required="required" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}">
                </p>
                <p>
		...
		<?php $atr = array('id' => 'reset_pwd');
				...
				<?php } 
                 ...
                 <p>
                    ...
                    <input id="inputemaily" type="email" name="inputemaily" autocomplete="off" required="required" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}">
                </p>
                 <p>
                    <label>&nbsp;</label>
	   ...
	   ?>
            ...
            <section class="loginBox">
                ...
                <p>
                    ...
                    <input type="email" id="emailAddress" name="emailAddress" value="" maxlength="64" required pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}">
                </p>
                <p>
                    <label>&nbsp;</label>
