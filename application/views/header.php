...
<![endif]-->
<script>console.log('view/header.php')</script>
<script>
...
<!--      <li><span>lac</span></li>
  ...
  <section class="top-nav">
 	<div class="container">
      ...
      <li><a href="<?php echo JEWISH_URL;?>/myaccount/classified_message/received/"><img src="<?php echo JEWISH_URL;?>/images/messager.png"/></a></li>
      <!--msg.png-->
